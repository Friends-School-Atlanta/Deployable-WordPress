...
class GFHelpScout extends GFFeedAddOn {
	...
	public function maybe_create_conversation() {
		...
		if ( $this->get_entry_converstaion_id( $entry ) ) {
			return;
		}
	...
	public function add_note_checkbox( $note_button ) {
		...
		if ( ! $this->initialize_api() || is_wp_error( $entry ) || ! $this->get_entry_converstaion_id( $entry ) ) {
			return $note_button;
		}
	 ...
	 * @return string
	 */
	public function get_entry_converstaion_id( $entry ) {
